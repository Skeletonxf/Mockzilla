...
## [1.2.0-alpha2](https://github.com/Skeletonxf/Mockzilla/compare/v1.1.0-alpha2...v1.2.0-alpha2) (2023-10-04)


### Features

* Add the ability to specify custom log writers on mockzilla ([ce8108e](https://github.com/Skeletonxf/Mockzilla/commit/ce8108e79fcaf2b198cf66878be167ac47fc3fd1))


### Bug Fixes

* Fix proguard rules to prevent users needing to add rules to app level files ([b00887d](https://github.com/Skeletonxf/Mockzilla/commit/b00887dd5c9f859b2ded23936742ec173348b3a8))
* Fix runtime crash which happens only on proguarded non-debuggable builds ([60af941](https://github.com/Skeletonxf/Mockzilla/commit/60af94106c42338eafa4e5c2505b6131d1ce2226))
* mimick a fix release to test release pipeline ([b97e8fb](https://github.com/Skeletonxf/Mockzilla/commit/b97e8fb0ecdb259c6e0a503f8f61930f7d129a4b))
